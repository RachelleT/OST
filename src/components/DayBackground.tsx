...
const SHAPES: Record<string, (p: Palette) => React.ReactElement> = {
  Monday: (p) => (
    <svg viewBox="0 0 320 580" preserveAspectRatio="xMidYMid slice" className="absolute inset-0 w-full h-full" aria-hidden="true">
      ...
      <circle cx="38" cy="200" r="11" fill={p.accent} />
  ...
  Tuesday: (p) => (
    <svg viewBox="0 0 320 580" preserveAspectRatio="xMidYMid slice" className="absolute inset-0 w-full h-full" aria-hidden="true">
      ...
      <circle cx="35" cy="195" r="9" fill={p.accent} />
  ...
  Wednesday: (p) => (
    <svg viewBox="0 0 320 580" preserveAspectRatio="xMidYMid slice" className="absolute inset-0 w-full h-full" aria-hidden="true">
      ...
      <circle cx="40" cy="205" r="10" fill={p.accent} />
  ...
  Thursday: (p) => (
    <svg viewBox="0 0 320 580" preserveAspectRatio="xMidYMid slice" className="absolute inset-0 w-full h-full" aria-hidden="true">
      ...
      <circle cx="36" cy="198" r="10" fill={p.accent} />
  ...
  Friday: (p) => (
    <svg viewBox="0 0 320 580" preserveAspectRatio="xMidYMid slice" className="absolute inset-0 w-full h-full" aria-hidden="true">
      ...
      <circle cx="39" cy="202" r="11" fill={p.accent} />
  ...
  Saturday: (p) => (
    <svg viewBox="0 0 320 580" preserveAspectRatio="xMidYMid slice" className="absolute inset-0 w-full h-full" aria-hidden="true">
      ...
      <circle cx="37" cy="200" r="10" fill={p.accent} />
  ...
  Sunday: (p) => (
    <svg viewBox="0 0 320 580" preserveAspectRatio="xMidYMid slice" className="absolute inset-0 w-full h-full" aria-hidden="true">
      ...
      <circle cx="38" cy="202" r="10" fill={p.accent} />
